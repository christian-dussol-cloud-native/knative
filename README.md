# Knative Learning Resources

[![CNCF Project](https://img.shields.io/badge/CNCF-Graduated-blue)](https://knative.dev/)

> Educational repository for learning Knative serverless platform on Kubernetes
...
**Vendor neutral by design.** Works on ANY Kubernetes (AWS, Azure, GCP, on-premise...).
...
**Part of CNCF Project Focus series** - Episode #1: Knative
